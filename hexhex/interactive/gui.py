...
def _get_colors(dark_mode: bool):
    return {
        ...
        'LINES': WHITE if dark_mode else BLACK,
        'PLAYER_1': STRAWBERRY if dark_mode else STRAWBERRY,
        'PLAYER_2': AZURE if dark_mode else AZURE
    }
...
class Gui:
    def __init__(self, board, radius, dark_mode=False):
        ...
        pygame.display.set_caption("__HEX__")
